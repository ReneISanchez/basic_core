...
-- alu_result_o[0]	=>  Location: PIN_F1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[1]	=>  Location: PIN_J6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[2]	=>  Location: PIN_G3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[3]	=>  Location: PIN_L1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[4]	=>  Location: PIN_M2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[5]	=>  Location: PIN_K2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[6]	=>  Location: PIN_M1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[7]	=>  Location: PIN_J3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[8]	=>  Location: PIN_H5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[9]	=>  Location: PIN_K3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[10]	=>  Location: PIN_J4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[11]	=>  Location: PIN_L4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[12]	=>  Location: PIN_J7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[13]	=>  Location: PIN_M7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[14]	=>  Location: PIN_M4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[15]	=>  Location: PIN_G2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[16]	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[17]	=>  Location: PIN_K4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[18]	=>  Location: PIN_H6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[19]	=>  Location: PIN_F5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[20]	=>  Location: PIN_L6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[21]	=>  Location: PIN_N8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[22]	=>  Location: PIN_K1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[23]	=>  Location: PIN_E1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[24]	=>  Location: PIN_L3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[25]	=>  Location: PIN_K7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[26]	=>  Location: PIN_L8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[27]	=>  Location: PIN_G1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[28]	=>  Location: PIN_N4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[29]	=>  Location: PIN_L2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[30]	=>  Location: PIN_N3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_o[31]	=>  Location: PIN_M5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- alu_result_valid_o	=>  Location: PIN_M3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- stop_o	=>  Location: PIN_F2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_J1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- n_reset	=>  Location: PIN_L7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst_regTwo.opcode[0]~feeder_combout\ : std_logic;
...
SIGNAL \inst_regTwo.opcode\ : std_logic_vector(1 DOWNTO 0);
SIGNAL regFile_to_ALU1 : std_logic_vector(31 DOWNTO 0);
SIGNAL regFile_to_ALU2 : std_logic_vector(31 DOWNTO 0);
SIGNAL \inst_regOne.opcode\ : std_logic_vector(1 DOWNTO 0);
SIGNAL \inst_regOne.rs\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \inst_regOne.rd\ : std_logic_vector(3 DOWNTO 0);
...
-- Equation(s):
-- \pc[1]~0_combout\ = (\n_reset~input_o\ & ((pc(1) & ((pc(2)) # (!pc(0)))) # (!pc(1) & ((pc(0))))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst_regOne.opcode\(1));

-- Location: FF_X2_Y32_N3
\inst_regTwo.opcode[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk~inputclkctrl_outclk\,
	asdata => \inst_regOne.opcode\(1),
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst_regTwo.opcode\(1));
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst_regOne.opcode\(0));

-- Location: LCCOMB_X2_Y32_N20
\inst_regTwo.opcode[0]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst_regTwo.opcode[0]~feeder_combout\ = \inst_regOne.opcode\(0)
...
-- pragma translate_on
PORT MAP (
	datad => \inst_regOne.opcode\(0),
	combout => \inst_regTwo.opcode[0]~feeder_combout\);

-- Location: FF_X2_Y32_N21
\inst_regTwo.opcode[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk~inputclkctrl_outclk\,
	d => \inst_regTwo.opcode[0]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst_regTwo.opcode\(0));

-- Location: LCCOMB_X2_Y32_N24
\alu|Add0~12\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Add0~12_combout\ = regFile_to_ALU1(0) $ (((!\inst_regTwo.opcode\(1) & \inst_regTwo.opcode\(0))))
...
-- pragma translate_on
PORT MAP (
	datab => \inst_regTwo.opcode\(1),
	datac => regFile_to_ALU1(0),
	datad => \inst_regTwo.opcode\(0),
	combout => \alu|Add0~12_combout\);

-- Location: LCCOMB_X2_Y32_N4
\alu|Add0~14\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Add0~14_cout\ = CARRY((\inst_regTwo.opcode\(1)) # (!\inst_regTwo.opcode\(0)))
...
-- Equation(s):
-- \alu|Add0~15_combout\ = (regFile_to_ALU2(0) & ((\alu|Add0~12_combout\ & (!\alu|Add0~14_cout\)) # (!\alu|Add0~12_combout\ & (\alu|Add0~14_cout\ & VCC)))) # (!regFile_to_ALU2(0) & ((\alu|Add0~12_combout\ & ((\alu|Add0~14_cout\) # (GND))) # 
-- (!\alu|Add0~12_combout\ & (!\alu|Add0~14_cout\))))
-- \alu|Add0~16\ = CARRY((regFile_to_ALU2(0) & (\alu|Add0~12_combout\ & !\alu|Add0~14_cout\)) # (!regFile_to_ALU2(0) & ((\alu|Add0~12_combout\) # (!\alu|Add0~14_cout\))))
...
-- Equation(s):
-- \alu|Add0~28_combout\ = (\alu|Add0~15_combout\ & (\inst_regTwo.opcode\(1) $ (\inst_regTwo.opcode\(0))))
...
-- Equation(s):
-- \alu|Equal1~0_combout\ = (\inst_regTwo.opcode\(0) & !\inst_regTwo.opcode\(1))
...
-- pragma translate_on
PORT MAP (
	datab => \inst_regTwo.opcode\(0),
	datad => \inst_regTwo.opcode\(1),
...
-- Equation(s):
-- \alu|Add0~17_combout\ = (\alu|Add0~16\ & ((\alu|Equal1~0_combout\ $ (!regFile_to_ALU1(1))))) # (!\alu|Add0~16\ & (\alu|Equal1~0_combout\ $ (regFile_to_ALU1(1) $ (GND))))
-- \alu|Add0~18\ = CARRY((!\alu|Add0~16\ & (\alu|Equal1~0_combout\ $ (!regFile_to_ALU1(1)))))
...
-- Equation(s):
-- \alu|Add0~29_combout\ = (\alu|Add0~17_combout\ & (\inst_regTwo.opcode\(1) $ (\inst_regTwo.opcode\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst_regTwo.opcode\(1),
	datac => \inst_regTwo.opcode\(0),
...
-- Equation(s):
-- \alu|Add0~19_combout\ = (\alu|Equal1~0_combout\ & ((regFile_to_ALU2(2) & (!\alu|Add0~18\)) # (!regFile_to_ALU2(2) & ((\alu|Add0~18\) # (GND))))) # (!\alu|Equal1~0_combout\ & ((regFile_to_ALU2(2) & (\alu|Add0~18\ & VCC)) # (!regFile_to_ALU2(2) & 
-- (!\alu|Add0~18\))))
-- \alu|Add0~20\ = CARRY((\alu|Equal1~0_combout\ & ((!\alu|Add0~18\) # (!regFile_to_ALU2(2)))) # (!\alu|Equal1~0_combout\ & (!regFile_to_ALU2(2) & !\alu|Add0~18\)))
...
-- Equation(s):
-- \alu|Add0~30_combout\ = (\alu|Add0~19_combout\ & (\inst_regTwo.opcode\(1) $ (\inst_regTwo.opcode\(0))))
...
-- Equation(s):
-- \alu|Add0~21_combout\ = regFile_to_ALU1(3) $ (((!\inst_regTwo.opcode\(1) & \inst_regTwo.opcode\(0))))
...
-- Equation(s):
-- \alu|Add0~22_combout\ = ((regFile_to_ALU2(3) $ (\alu|Add0~21_combout\ $ (\alu|Add0~20\)))) # (GND)
-- \alu|Add0~23\ = CARRY((regFile_to_ALU2(3) & ((!\alu|Add0~20\) # (!\alu|Add0~21_combout\))) # (!regFile_to_ALU2(3) & (!\alu|Add0~21_combout\ & !\alu|Add0~20\)))
...
-- Equation(s):
-- \alu|Add0~31_combout\ = (\alu|Add0~22_combout\ & (\inst_regTwo.opcode\(1) $ (\inst_regTwo.opcode\(0))))
...
-- Equation(s):
-- \alu|Add0~24_combout\ = (\inst_regTwo.opcode\(0) & ((\inst_regTwo.opcode\(1) & (!\alu|Add0~23\)) # (!\inst_regTwo.opcode\(1) & ((\alu|Add0~23\) # (GND))))) # (!\inst_regTwo.opcode\(0) & (((!\alu|Add0~23\))))
-- \alu|Add0~25\ = CARRY(((\inst_regTwo.opcode\(0) & !\inst_regTwo.opcode\(1))) # (!\alu|Add0~23\))
...
-- Equation(s):
-- \alu|Add0~32_combout\ = (\alu|Add0~24_combout\ & (\inst_regTwo.opcode\(1) $ (\inst_regTwo.opcode\(0))))
...
-- Equation(s):
-- \alu|Add0~26_combout\ = \alu|Add0~25\ $ (((\inst_regTwo.opcode\(0) & !\inst_regTwo.opcode\(1))))
...
-- Equation(s):
-- \alu|Add0~33_combout\ = (\alu|Add0~26_combout\ & (\inst_regTwo.opcode\(0) $ (\inst_regTwo.opcode\(1))))
...
-- Equation(s):
-- \alu|result_o~0_combout\ = \inst_regTwo.opcode\(0) $ (\inst_regTwo.opcode\(1))
...
-- Equation(s):
-- \alu|Equal1~1_combout\ = (\inst_regTwo.opcode\(0) & \inst_regTwo.opcode\(1))
